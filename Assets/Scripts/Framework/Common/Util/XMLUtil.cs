...
public class XMLUtil
{
    ...
    public static XmlDocument GetEssentialXmlCfg(string path)
    {
        ...
        {
#if UNITY_EDITOR
            ret = getXMLFromFile(BuildConfigPath(path));
#else
            //TODO 非编辑器环境
    ...
    public static XmlTextReader GetXmlCfgByReader(string path)
    {
        ...
        {
#if UNITY_EDITOR
            reader = GetXMLFromFile(BuildConfigPath(path));
#else
            //TODO 非编辑器环境
            //AssetBundle ab = AssetBundleMgr.instance.m_normalCfgBundle;
    ...
    static string BuildConfigPath(string name)
    {
#if UNITY_EDITOR
        string path = "Assets/GAssets/Launch/Res/Config/" + name;
